...
public class TkGV extends JFrame implements ActionListener {
    ...
    public TkGV(String s) {
        super(s);
        try {

            //ket noi den csdl va tao doi tuong stament
            Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            conn = DriverManager.getConnection("jdbc:sqlserver://DESKTOP-MSPCRA5:1433;databaseName =lol",
                    "sa", "123");
...
//        tb1.addMouseListener(this);
    ...
    public void reload1()
    {
        try {
            ...
            vTitle1.clear();
            vData1.clear();
            ResultSet rst = stm.executeQuery("select * from GiangVien where id='"+s+"'");
...
//            GiangVien l=new GiangVien("Giang Vien");
//            l.setVisible(true);
            setVisible(false);
        }
