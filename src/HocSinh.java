...
public class HocSinh extends JFrame implements ActionListener, MouseListener {
    ...
    public HocSinh(String s) {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:sqlserver://DESKTOP-MSPCRA5:1433;databaseName =lol", "sa", "123");
    ...
    public void reload()
    {
        try {
            ...
            vTitle.clear();
            vData.clear();
            ResultSet rst = stm.executeQuery("select * from tblSINHVIEN");
    ...
    public void delete() {
        try {
            ...
            String sql = "Delete from tblSINHVIEN where id ='" + st.elementAt(0) + "'";
